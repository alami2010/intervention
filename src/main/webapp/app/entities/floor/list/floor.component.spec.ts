...
describe('Floor Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'floor', component: FloorComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to floorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFloorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFloorIdentifier).toHaveBeenCalledWith(entity);
